 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://services.gharralabs.br/", wsdlLocation = "http://localhost:9999/api/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://services.gharralabs.br/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/api/hello?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://services.gharralabs.br/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.gharralabs.br/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
